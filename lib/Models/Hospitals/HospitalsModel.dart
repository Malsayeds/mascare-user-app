...
List<HospitalsModel> hospitalsModelFromJson(String str) => List<HospitalsModel>.from(json.decode(str).map((x) => HospitalsModel.fromJson(x)));

String hospitalsModelToJson(List<HospitalsModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
